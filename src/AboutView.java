...
public class AboutView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("F:\\Download\\barefeet.ID (3).png")); // NOI18N

        jLabel2.setText("Aplikasi BareFeet.ID v1.0");

        jLabel3.setText("Tugas Akhir Praktikum DKP");

        jLabel4.setText("Developed By :");

        jLabel5.setText("Muhammad Ishaq Matanggwan");

        jLabel6.setText("21120119130053");
